  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-3xl mx-auto">
        <div className="bg-white p-10 rounded-xl border border-gray-100" id="invoice-print-area">
          ...
          <div className="print:hidden border-t border-gray-100 pt-6 flex items-center justify-between">
            <PayButton token={token} status={status} total={fmt(totals.total)} />
          </div>
        </div>
      </div>
    </div>
